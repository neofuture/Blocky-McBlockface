...
<head>
    <meta charset="UTF-8">
    <title>Blocky McBlockface Privacy Policy</title>
    <style>
        body {
        ...
        .header {
            ...
            height: 112px;
            padding: 30px;
            background: url(images/country.png) no-repeat center center fixed;
...
<body>
<div class="header">
    <img src="images/icon.jpg" alt="Blocky McBlockface" title="Blocky McBlockface" class="icon">
    <h1>Privacy Policy</h1>
</div>
<div class="policy">
    <div id="privacy_content"><h2>Privacy Policy</h2>
        <p> Carl Fearby built the Blocky McBlockface app as an Ad Supported app. This SERVICE is provided by Carl Fearby at
        ...
        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
            accessible
            at Blocky McBlockface unless otherwise defined in this Privacy Policy.
        </p>
        <p><strong>Information Collection and Use</strong></p>
        <p>For a better experience, while using our Service, I may require you to provide us with certain
            personally identifiable information. The information that I request will be retained on your device and is
        ...
        <p>If you have any questions or suggestions about my Privacy Policy, do not hesitate to email me <a href="mailto:someone@yoursite.com?subject=Blocky McBlockface">info@vertinero.com</a>
        </p>
    </div>
</body>
</html>